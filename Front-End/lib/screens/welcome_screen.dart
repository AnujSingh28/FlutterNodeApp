...
class CurvePainter extends CustomPainter {
  ...
  CurvePainter({this.midHeight = 0.65});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    curve.quadraticBezierTo(width * 0.2, height * (midHeight - 0.025),
        width * 0.5, height * midHeight);
    curve.quadraticBezierTo(width * 0.8, height * (midHeight + 0.025), width,
        height * (midHeight - 0.1));
