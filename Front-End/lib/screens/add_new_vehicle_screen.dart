...
enum FuelTypes { Petrol, Diesel, CNG, LPG, Electric }
...
class _NewVehicleScreenState extends State<NewVehicleScreen> {
  ...
  double mileage;
  RangeValues kilometersDriven =
      RangeValues(minKilometersDriven, maxKilometersDriven);
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: DropdownButton<FuelTypes>(
                  ...
                  value: fuelType,
                  items: FuelTypes.values
                      .map<DropdownMenuItem<FuelTypes>>((FuelTypes fuel) {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  RangeSlider(
                    ...
                    labels: RangeLabels('${kilometersDriven.start.floor()}',
                        '${kilometersDriven.end.floor()}'),
                  )
                ],
              ),
            ),
